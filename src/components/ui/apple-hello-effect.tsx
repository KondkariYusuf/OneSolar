...
export function AppleHelloEnglishEffect({ className }: { className?: string }) {
  ...
  return (
    <div className={`relative flex items-center justify-center overflow-hidden ${className}`}>
      ...
      >
        <span className={`font-apple-hello ${isDark ? 'text-black/40' : 'text-white/30'} text-[18px] sm:text-[22px] md:text-[26px] tracking-wide block py-2 select-none leading-none transition-colors duration-500`}>
